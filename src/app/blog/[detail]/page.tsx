            ...
            <article className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700" style={{ fontFamily: 'var(--font-content)' }}>
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        {/* Breadcrumb */}
                        <nav className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 mb-8 mt-12 whitespace-nowrap overflow-hidden">
                            <Link href="/home" scroll={false} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                首页
                            </Link>
                            ...
                            <span className="text-gray-900 dark:text-white max-w-[14rem] sm:max-w-xs lg:max-w-sm truncate" title={post.title}>
                                {post.title}
                            </span>
                        </nav>
